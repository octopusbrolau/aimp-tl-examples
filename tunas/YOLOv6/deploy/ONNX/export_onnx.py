...
if __name__ == '__main__':
    ...
    parser.add_argument('--saved_model', action='store_true', help='export tf saved model')
    ...
    parser.add_argument('--topk-all', type=int, default=5, help='topk objects for every images')
    ...
    try:
        ...
        if args.saved_model:
            ...
            tf_export_path = export_file.replace(os.path.basename(export_file), 'tf_exported')  # filename
            tf_rep.export_graph(tf_export_path)  # export to saved model
            LOGGER.info(f'SavedModel export success, saved as {tf_export_path}')
