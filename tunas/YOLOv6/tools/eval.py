...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--letterbox_return_int', default=True, action='store_true', help='return int offset for letterbox')
    parser.add_argument('--scale_exact', default=True, action='store_true', help='use exact scale size to scale coords')
    parser.add_argument('--force_no_pad', default=True, action='store_true', help='for no extra pad in letterbox')
    parser.add_argument('--not_infer_on_rect', default=True, action='store_true', help='default to use rect image size to boost infer')
